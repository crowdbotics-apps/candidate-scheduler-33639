...
## Project Structure
    ...
    ├── candidate_scheduler_33639  # Django project configurations
...
1. Clone this repo and `cd candidate_scheduler_33639`
...
2. Clone this repo and `cd candidate_scheduler_33639`
